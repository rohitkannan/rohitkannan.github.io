...
<div>
    <table style = "border: none;">
      <tr>
          <tr><td colspan = "2"><p style="font-size:20px;text-align:centre"><b>Viability of branch-and-bound (B&B) algorithms:</b></p></td></tr>  
        ...
        <td style = "border: none;">
          <p style="font-size:16px; text-align: justify"><b>Algorithms for two-stage stochastic programs:</b><br>
        ...
        <tr>
        <td style = "border: none;">
          <p style="font-size:16px; text-align: justify"><b>Optimization with reliability constraints:</b><br>
